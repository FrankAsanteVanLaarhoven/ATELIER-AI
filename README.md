...
[![Certification Aligned](https://img.shields.io/badge/Certification-Claude%20Certified%20Architect%20(CCAR--F)-10b981?style=for-the-badge&logo=anthropic)](https://github.com/FrankAsanteVanLaarhoven/ATELIER-AI)
[![Version](https://img.shields.io/badge/Release-v2.6%20Enterprise-38bdf8?style=for-the-badge)](https://github.com/FrankAsanteVanLaarhoven/ATELIER-AI)
[![Video Tech](https://img.shields.io/badge/Masterclass-Veo%203%20Pro%20%7C%20Nano%20Banana-f59e0b?style=for-the-badge)](https://github.com/FrankAsanteVanLaarhoven/ATELIER-AI)
[![Exam Engine](https://img.shields.io/badge/Exam%20Engine-60%20Items%20%7C%20120%20Min-6366f1?style=for-the-badge)](https://github.com/FrankAsanteVanLaarhoven/ATELIER-AI)
[![License](https://img.shields.io/badge/License-Apache%202.0-07080a?style=for-the-badge)](LICENSE)

<br/>

![Atelier AI Enterprise Architecture](demo/assets/hero.jpg)
...
```mermaid
graph TD
    A["Atelier OS Client UI (Linear / Keyline Aesthetics)"] --> B["Command Palette (Cmd+K) & Navigation"]
    A --> C["Cinematic Video Player (Veo 3 Pro / Nano Banana)"]
    A --> D["Interactive Sandboxes (CLI, MCP, Agent Graph, Slides)"]
    A --> E["Assessment Engine (60-Item Timed Mock & Drills)"]
    A --> F["Case Study Failure Injection Labs"]
    A --> G["100-Point Capstone Defense Studio"]

    C --> C1["Live Synchronized Code Checkpoints"]
    C --> C2["Audio-Reactive Canvas Streams"]
    
    D --> D1["Claude Code Terminal Emulator"]
    D --> D2["MCP JSON-RPC Validator & Error Taxonomy"]
    D --> D3["Multi-Agent Graph & Context Bloat Meter"]
    D --> D4["Slide Studio with Provenance Citations"]
    
    E --> E1["CCAR-F Domain-Weighted Quotas (60 Items / 120m)"]
    E --> E2["Post-Exam Diagnostic Radar & Heatmaps"]
    
    F --> F1["01 Support Refund Agent (Timeout & Idempotency)"]
    F --> F2["02 Monorepo Code Delivery (Context Compaction)"]
    F --> F3["03 Executive Operations (Conflict Resolution)"]
    
    G --> G1["10-Deliverable Validation Checklist"]
    G --> G2["100-Point Rubric & Faculty Defense"]
    G --> G3["Digital Credential & SVG Certificate"]
```
